"""
Top level module for dynfwmgr application.
...
from dynfwmgr import VERSION
from dynfwmgr.app import DynFwMgr
from dynfwmgr.foos import create_handler
...
def main(  # noqa: WPS216
    ...
    if not test:
        requires_super_user("When --no-test  dynfwmgr")
